...
def send_email(name, dest, link):
    ...
    server.login("testmail.rm1@gmail.com", "bggdecywvpfqdmds")
    ...
    msg["From"] = formataddr(("TEAM RESCUE", "testmail.rm1@gmail.com"))

    # One last time add your email
    server.sendmail("testmail.rm1@gmail.com", dest, msg.as_string())
    server.quit()
